...
const ForgotPasswordPage = () => {
  ...
  return (
    ...
    <body className="alignlogin box1">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" className="iconslogin">
